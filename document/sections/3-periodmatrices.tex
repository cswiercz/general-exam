...
For algebraic curves, local coordinates are instead given in terms of
Puiseux series.
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw[font=\small] (0,-0.5) node {$\gamma$};
    \end{scope}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw[darkblue]
          ...
          controls (-5,-2) and (-3,-2) ..
          (0,0);
    \draw[font=\small] (0,-1.1) node {$\gamma$};
    \end{scope}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw[font=\small] (0,-1.1) node {$\gamma = \gamma_1 + \gamma_2$};\
    \draw[font=\small] (-4,1.7)  node {$\gamma_1$};
    \draw[font=\small] (4,1.7)   node {$\gamma_2$};
    \end{scope}
  \end{tikzpicture}
...
To compute $A_{ij}, B_{ij}$ we first describe a method for numerically
